...
public interface BorrowedDAOInterface {
    ...
    /**
     * Used to check if borrowed request is already done by user.
     * @param userID Used to identify what borrowed they are looking for
     * @param titleID Used to identify what borrowed they are looking for
     * @return Borrowed variable with all details on it.
     */
